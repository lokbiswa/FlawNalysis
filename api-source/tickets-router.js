...
connectionString = `mongodb+srv://${username}:${password}@cluster0.d0ygw.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
// port # from .env
...
function assignTech(reqBody) {
  ...
  let { name, status, type, priority, ticketDetails, email, requestedDate } =
    reqBody;
  return (data = {
    name,
    status,
